...
import com.gmail.mateendev3.allnetworkpackages.databinding.ActivityPtclBinding;
import com.gmail.mateendev3.allnetworkpackages.databinding.ActivityUfoneBinding;

public class PTCLActivity extends AppCompatActivity {

    //declaring and initializing members
    private ActivityPtclBinding binding;
    public static final String GOTO = "PTCLActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityPtclBinding.inflate(getLayoutInflater());
    ...
    private void setClickListenersToLL() {
        binding.llOpenTelephonePackages.setOnClickListener(v -> {
            startPackagesActivity(1);
        });
        binding.llOpenInternetPackages.setOnClickListener(v -> {
            startPackagesActivity(3);
        });
        binding.llOpenSmartTvPackages.setOnClickListener(v -> {
    ...
    /**
     * method to start packages activity according to linear layout (value)
