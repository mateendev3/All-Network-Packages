...
import com.gmail.mateendev3.allnetworkpackages.databinding.ActivityJazzWaridBinding;

public class JazzWaridActivity extends AppCompatActivity {

    //declaring and initializing members
    private ActivityJazzWaridBinding binding;
    public static final String GOTO = "JazzWaridActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityJazzWaridBinding.inflate(getLayoutInflater());
